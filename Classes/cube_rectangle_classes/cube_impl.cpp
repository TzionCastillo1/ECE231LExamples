...
Cube::Cube() : Rectangle(), _depth{1}, _volume{1}, _surface_area{6} {}
...
//We are changing the Rectangle class' set_length and set_width
//This is possible because we used the virtual keyword in rectangle.hpp
//and the override keyword in cube.hpp
...
std::ostream& operator<<(std::ostream & out, cont Cube& c){
